...
for (const pais of paises) {
  ...
  cardGenerado += ` <article
        class="rounded-lg max-w-80 flex flex-col items-center justify-center bg-white dark:bg-[#2c3743] dark:text-white shadow-md active:scale-90 active:transition active:duration-150 md:hover:scale-110 md:transition md:duration-200 md:max-w-65"
      ><div class="w-full h-[60%]">
       <img
        ...
        <div class="flex flex-col mt-4 gap-2 mb-10 w-full pl-6 font-semibold">
          <h2 ><span class="font-bold text-2xl cursor-pointer active:text-blue-400 active:transition active:duration-100">${pais.name}</span></h2>
